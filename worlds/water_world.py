...
class WaterWorldParams:
    def __init__(self, state_file = None, max_x = 1000, max_y = 700, b_num_colors = 6, 
                       b_radius = 20, b_velocity = 30, b_num_per_color = 12,
...
class WaterWorld:
    ...
    def get_state(self):
        return self.get_features() # we are only using "simple reward machines" for the craft domain
...
#     os.chdir("../")
#
#     tester = Tester(LearningParameters(), TestingParameters(), "../Maps/water/tests/water_7.txt", False)
#     if tester is None:
#         task = "../Maps/water/reward_machines/t1.txt"
#         state_file = "../Maps/water/maps/world_0.pkl"
#         max_x = 400
#         max_y = 400
#         b_num_per_color = 2
#         b_radius = 15
...
#     rm = RewardMachine(task, False, 0.9)
#     s1 = game.get_state()
...
#         reward = rm.get_reward(u1,u2,s1,a,s2, False)
#
#         # printing image
...
#     pygame.quit()
#
# def save_random_world(num_worlds, folder_out="../../Maps/water/maps/"):
#     max_x = 400
#     max_y = 400
#     b_num_per_color = 2
#     b_radius = 15
